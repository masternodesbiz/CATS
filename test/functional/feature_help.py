...
"""Verify that starting CATS with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start CATS with -? for help text")
        ...
        self.log.info("Start CATS with -version for version information")
