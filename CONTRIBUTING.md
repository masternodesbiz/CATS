Contributing to CATS Core
============================

The CATS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CATS Core project, and is not to be
confused with overall CATS Network Protocol consensus changes.

Whether a pull request is merged into CATS Core rests with the project merge
...
Patches that change CATS consensus rules are considerably more involved than
...
Where a patchset proposes to change the CATS consensus, it must have been
...
The project leader is the release manager for each CATS Core release.
