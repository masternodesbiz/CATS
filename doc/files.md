...
CATS.conf           | contains configuration settings for CATSd or CATS-qt
CATSd.pid           | stores the process id of CATSd while running
...
debug.log           | contains debug information and general logging generated by CATSd or CATS-qt
