...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 150 * COIN;    
    } else if (nHeight <= 440000 && nHeight >= 400000) {
        nSubsidy = 150 * COIN;
    } else if (nHeight <= 480000 && nHeight >= 440000) {
        nSubsidy = 140 * COIN;
    } else if (nHeight <= 520000 && nHeight >= 480000) {
        nSubsidy = 130 * COIN;
    } else if (nHeight <= 550000 && nHeight >= 520000) {
        nSubsidy = 120 * COIN;
    } else if (nHeight <= 570000 && nHeight >= 550000) {
        nSubsidy = 110 * COIN;
