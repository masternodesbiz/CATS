...
public:
    ...
    QSpacerItem *verticalPercentage;
    QLabel *labelDivider;
    ...
    void setupUi(QWidget *SettingsMainOptionsWidget)
    {
        ...
        verticalPercentage = new QSpacerItem(20, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        verticalLayout_2->addItem(verticalPercentage);
