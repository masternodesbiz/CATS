...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("0 CATS"));
        ...
        labelPiv->setText(QStringLiteral("CATS"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get CATS", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Rewards Chart", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of CATS staked.", Q_NULLPTR));
        ...
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "CATS MN", Q_NULLPTR));
