...
"             }"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (CATS)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "CATS address or contact label", Q_NULLPTR));
