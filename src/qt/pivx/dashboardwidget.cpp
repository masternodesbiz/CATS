    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of CATS earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 CATS");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair CATS
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(255,94,94));
