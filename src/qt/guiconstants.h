...
/* CATS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CATS"
#define QAPP_ORG_DOMAIN "CATS.org"
#define QAPP_APP_NAME_DEFAULT "CATS-Qt"
#define QAPP_APP_NAME_TESTNET "CATS-Qt-testnet"
