...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CATS CATS-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CATS-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CATS transaction") + "\n" +
                               "  CATS-tx [options] -create [commands]   " + _("Create hex-encoded CATS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CATS transaction
