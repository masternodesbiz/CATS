...
const char * const PIVX_CONF_FILENAME = "CATS.conf";
const char * const PIVX_PID_FILENAME = "CATS.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\CATS
// Windows >= Vista: C:\Users\Username\AppData\Roaming\CATS
// Mac: ~/Library/Application Support/CATS
// Unix: ~/.CATS
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CATS";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty CATS.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=15885\naddnode=seed1.masternodes.guru/CATS:15886\naddnode=seed2.masternodes.guru/CATS:15886\naddnode=seed3.masternodes.guru/CATS:15886\naddnode=seed4.masternodes.guru/CATS:15886\naddnode=seed5.masternodes.guru/CATS:15886\naddnode=seed6.masternodes.guru/CATS:15886\naddnode=seed7.masternodes.guru/CATS:15886\naddnode=seed8.masternodes.guru/CATS:15886\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override CATS.conf
