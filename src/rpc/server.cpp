...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CATS features */
        {"CATS", "listmasternodes", &listmasternodes, true },
        {"CATS", "getmasternodecount", &getmasternodecount, true },
        {"CATS", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"CATS", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"CATS", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"CATS", "masternodecurrent", &masternodecurrent, true },
        {"CATS", "startmasternode", &startmasternode, true },
        {"CATS", "createmasternodekey", &createmasternodekey, true },
        {"CATS", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"CATS", "listmasternodeconf", &listmasternodeconf, true },
        {"CATS", "getmasternodestatus", &getmasternodestatus, true },
        {"CATS", "getmasternodewinners", &getmasternodewinners, true },
        {"CATS", "getmasternodescores", &getmasternodescores, true },
        {"CATS", "mnsync", &mnsync, true },
        {"CATS", "spork", &spork, true },
        {"CATS", "getcollateral", &getcollateral, true},
...
{
    return "> CATS-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15885/\n";
}
