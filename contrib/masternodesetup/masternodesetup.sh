...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='CATS.conf'
CONFIGFOLDER='/root/.CATS'
COIN_DAEMON='CATSd'
COIN_CLI='CATS-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/CATS/CATS/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
