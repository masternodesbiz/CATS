...
#define MyAppName "CATS Core"
#define MyAppPublisher "2021-2022 The CATS Developers"
#define MyAppURL "https://github.com/Masternodesguru/CATS"
#define MyAppExeName "CATS-qt.exe"
#define MyAppExtraData "https://github.com/Masternodesguru/CATS/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\CATS-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\CATS\CATS-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\CATS\CATS-Qt,strDataDir|{userappdata}\CATS\}');
  Result := True;
end;
