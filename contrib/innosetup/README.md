...
* Fill in the following data:
    * Application Name: `CATS Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The CATS Developers`
    * Application Website: `https://masternodes.guru/CATS/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `CATS`
* Add application files:
    * Select the file `CATS-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `CATS-2.0.0-win64-setup.exe`
